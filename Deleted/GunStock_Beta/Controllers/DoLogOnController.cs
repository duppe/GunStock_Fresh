        ...
        public string Post([FromBody]string Jsonstring)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        Console.WriteLine(item["ClientPassword"]);
                        Console.WriteLine(item["ClientEmail"]);
                        Console.WriteLine(item["BaseAKA"]);
                        try
                        {
                            if (ClientEmail == item["ClientEmail"] & ClientPassword == item["ClientPassword"] & Service == item["Service"])
                            {
                            ...
                            if (NewPassword == "1")
                            {
                                strSQL = "update " + BaseAKA + "_LogOn set ClientPassword = '" + ClientPassword + "', ClientChangePassword = 0 where ClientEmail = '" + ClientEmail + "'";
                            ...
                            return ClientSessionPassword + "|" + CLientUrl + "|" + ClientLevel + "|" + ClientTimeOutValue + "|" + ClientChangePassword + "|" + CLientName + "|" + BaseAKA;
