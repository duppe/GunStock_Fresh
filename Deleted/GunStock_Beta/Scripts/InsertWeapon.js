...
function MDoPost() {
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            document.getElementById('M2result').innerHTML = "<h1>**** Endringer Godkjent ****</h1>";
...
function DoGetTheWeapon(S) {
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            DoModifyListing(myObjE[0].DateOppdatert, myObjE[0].Bestilt, myObjE[0].ID, myObjE[0].Leverandor, myObjE[0].Merke, myObjE[0].Modell, myObjE[0].Caliber, myObjE[0].LopLengde, myObjE[0].Serienummer, myObjE[0].Status, myObjE[0].Mekanisme, myObjE[0].Eier);
            CheckIfExist();
        }
    };
    xhr.send(JSON.stringify(MJson));
