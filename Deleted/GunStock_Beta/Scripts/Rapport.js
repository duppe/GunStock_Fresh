...
function DoFillRapport() {
    ...
    var MJson = '{"Search" : "71_' + Status + '|' + Periode + '|' + Ar + '", "SessionPassword" : "' + readCookie('SessionPassword') + '", "BaseAKA" : "' + readCookie('BaseAKA') + '"}';
        ...
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            for (var key in myObjE) {
                if (myObjE.hasOwnProperty(key)) {
                    ...
                    Linje += "<div id='R" + key + "'><tr style='background-color:#" + ColorLine + ";' id='list" + key + "'><td>&nbsp;<a href=\"#\"><img onclick=\'parent.DoNewBrowserTab(\"InsertWeapon.html?id=" + myObjE[key].ID + "\",null,\"våpen\");\' alt='' style='width:20px;' src='img/edit.gif' /></a></td><td >" + myObjE[key].Status + ", <a onclick=\"parent.DoNewBrowserTab('CostumerCard.html?TempUserID=" + myObjE[key].Kunde_ID + " ',null,'våpen<br><b>" + Eier + "</b>')\" href=\"#\">" + Eier + "</a></td><td >" + myObjE[key].Dato + "</td>  <td >" + myObjE[key].Merke + "</td> <td >" + myObjE[key].Modell + "</td> <td >" + myObjE[key].Caliber + "</td> <td>" + myObjE[key].LopLengde + "</td> <td >" + myObjE[key].Serienummer + "</td> <td >" + myObjE[key].Mekanisme + "</td> </tr></div>";
                }
            }
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            */
            ...
            Linje += "<p style='font - weight: bold; font - size: xx-large'>  " + Title + " -- Skitt Fiske AS, Viser tottalt&nbsp;" + myObjE.length + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " + Periode2 + "&nbsp;" + Ar + ", SideNummer : " + PageNumber + "</p>";
            ...
            for (var key in myObjE) {
                ...
                if (Temp == TotPage) {
                    ...
                    Linje += "<tr style='background-color:#C0C0C0;'><td >&nbsp;Status&nbsp;</td><td >&nbsp;Dato&nbsp;</td>  <td >Merke</td> <td>Modell</td><td>Leverandør</td> <td >Caliber</td> <td>Løp</td> <td>Serienummer</td>  <td>Mekanisme</td> </tr>";
                    Linje += "<p style='font - weight: bold; font - size: xx-large'>  " + Title + " Skitt Fiske AS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " + Periode2 + "&nbsp;" + Ar + ", SideNummer : " + PageNumber + "</p>";
            ...
            Linje += "</table>SideNummer : " + PageNumber;
            Linje += "<br />";
            Linje += " <p style='font - weight: bold; font - size: x - large'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tottalt  : " + TotItem + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " + DaysDate() + ",&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Signert av " + readCookie('CLientName') + "&nbsp; :&nbsp; _________________________________</p>";
