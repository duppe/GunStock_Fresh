...
function DoFill(drpName, ConstantID, Vari, NoLeadBlank) {
    ...
    var xhr = new XMLHttpRequest(),
        method = "GET",
        url = ServerURL + 'DoFill/' + ConstantID + "?Vari=" + Vari + "&SessionPassword=" + readCookie('SessionPassword') + "&BaseAKA=" + readCookie('BaseAKA');
...
function DoFillForm(drpName, ConstantID, Vari, BaseAKA) {
    ...
    var xhr = new XMLHttpRequest(),
        method = "GET",
        url = ServerURL + 'DoFillForm/' + ConstantID + "?Vari=" + DoHTMLencode(Vari) + "&SessionPassword=" + readCookie('SessionPassword') + "&BaseAKA=" + readCookie('BaseAKA');
...
function SendMail(Subject, Body) {
    ...
    var MJson = '{"case" : "SendMail", "Body" : "' + Body + '", "Subject" : "' + Subject + '", "BaseAKA" : "' + readCookie('BaseAKA') + '"}';
