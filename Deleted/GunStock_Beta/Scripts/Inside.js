...
function CheckSessionPass(SessionPass, ClientName) {
    ...
    var MJson = '{"ClientSessionPassword" : "' + readCookie('SessionPassword') + '", "BaseAKA" : "' + readCookie('BaseAKA') + '"}';
...
function GetBySerial(Serial) {
    ...
    if (Serial != "") {
        url = ServerURL + "lookup/"; //+ Serial.replaceAll(".", "§").replaceAll("+", "£") + "?SessionPassword=" + readCookie('SessionPassword');
        var MJson = '{"Search" : "' + Serial.replaceAll(".", "§").replaceAll("+", "£") + '", "SessionPassword" : "' + readCookie('SessionPassword') + '", "BaseAKA" : "' + readCookie('BaseAKA') + '"}';
