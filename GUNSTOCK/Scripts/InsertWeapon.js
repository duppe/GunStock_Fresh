    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            if (xhr.responseText != '\"[]\"') {
                ...
                DoModifyListing(myObjE[0].DateOppdatert, myObjE[0].Bestilt, myObjE[0].ID, myObjE[0].Leverandor, myObjE[0].Merke, myObjE[0].Modell, myObjE[0].Caliber, myObjE[0].LopLengde, myObjE[0].Serienummer, myObjE[0].Status, myObjE[0].Mekanisme, myObjE[0].ItemText, myObjE[0].Eier);
                //document.location.reload();
                CheckIfExist();
...
function DoModifyListing(DateOppdatert, Bestilt, ID, lLeverandor, lMerke, lModell, lCaliber, lLopLengde, lSerienummer, lStatus, lMekanisme, ItemText, lEier) {
