	   ...
	   ,case 
		  ...
		  ,case 
			...
			Skitt_Kunder_Update.[Poststed]
			 ...
			 ,case 
			when Skitt_Kunder_Update.[Postnummer] is null
			then Skitt_Kunder.[Postnummer]
			else
			Skitt_Kunder_Update.[Postnummer]
			end as 'Postnummer'
...
insert into Skitt_Kunder2 (Kundenr, Kundenavn, Adresse, Postnummer, Poststed, Telefon, EPostKunde, id, KundeVapen, Updated, ByUser, Info, NotOK, Inserted)
select Kundenr, Kundenavn, Adresse, Postnummer, Poststed, Telefon, EPostKunde, id, KundeVapen, Updated, ByUser, Info, NotOK, Inserted
 from #temp
go
